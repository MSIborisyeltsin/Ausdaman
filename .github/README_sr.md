...
# Ausdaman - "Zemlja zaboravljenih"

Modifikacija za TESV sa novim planom oblivion
<br>
Status: u eksperimentalnom režimu
<br>
<a href="https://github.com/MSIBorisieltsin/Ausdaman/blob/main/Logs/">Prikaži evidencije</a>

<!-- ## Promene tastera -->

## [Pomoć u razvoju](https://github.com/MSIBorisieltsin/Ausdaman/blob/main/.github/CONTRIBUTING.md)
### Zahtevi
obavezno:
- Creation Kit
- Skyrim
- NifScope
- Menadžer modifikacija
- BSA browser

Opciono:
- Softver za kreiranje 3D grafike
- DAV (Digitalna audio radna stanica)
- Multifunkcionalni grafički uređivač
...
> [!NOTE]
> Takođe će biti neophodno kreirati fascikle "Textures" i "Meshes" u fascikli "Data" u osnovnom direktorijumu igre, gde ćemo sačuvati teksture i druge stvari da bismo izbegli grešku "Invalid directory".

### Saveti za početnike
- [https://ck.uesp.net/](https://ck.uesp.net/viki)

### TODO
> [!TIP]
> Pre lokalizacije projekta, preporučljivo je izdati izdanje 🪚
- ~~Mod treba lokalizovati~~
- Neophodno je napraviti reljef
