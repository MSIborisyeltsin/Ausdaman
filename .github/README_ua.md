...
> [!NOTE]
> Також необхідно буде створити папки «Текстури» та «Сітки» в папці «Дані» кореневого каталогу гри, де ми будемо зберігати текстури та інші речі, щоб уникнути помилки «Недійсний каталог».
